...
public class MITEWorkbenchContainer extends RecipeBookContainer<CraftingInventory> {
	   ...
	   public MITEWorkbenchContainer(int p_i50089_1_, PlayerInventory p_i50089_2_) {
	      this(p_i50089_1_, p_i50089_2_, IWorldPosCallable.DUMMY, 0);
	   }
...
//		   }
	   ...
	   public MITEWorkbenchContainer(int p_i50090_1_, PlayerInventory p_i50090_2_, IWorldPosCallable p_i50090_3_, int table) {
