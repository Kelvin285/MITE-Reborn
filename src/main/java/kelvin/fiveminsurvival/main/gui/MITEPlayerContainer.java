...
public class MITEPlayerContainer extends PlayerContainer {
      ...
      for(int k = 0; k < 4; ++k) {
         ...
         this.addSlot(new Slot(playerInventory, 39 - k, 8, 8 + k * 18) {
            ...
            public String getSlotTexture() {
               return MITEPlayerContainer.ARMOR_SLOT_TEXTURES[equipmentslottype.getIndex()];
            }
         });
      }
   ...
   public void onCraftMatrixChanged(IInventory inventoryIn) {
      MITEWorkbenchContainer.func_217066_a(this.windowId, this.player.world, this.player, this.field_75181_e, this.field_75179_f);
   }
