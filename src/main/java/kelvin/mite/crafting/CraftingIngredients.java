...
public class CraftingIngredients {
	...
	public static void init() {
		...
		register(ItemRegistry.ROCK, CraftingIngredient.NO_WORKBENCH, 10);
		...
		register(Items.COPPER_INGOT, CraftingIngredient.COPPER_CRAFTING_TABLE, 20 * 2);
		...
		register(Material.SOIL, CraftingIngredient.NO_WORKBENCH, 15);
		register(Material.REPLACEABLE_PLANT, CraftingIngredient.NO_WORKBENCH, 10);
		register(Material.GLASS, CraftingIngredient.NO_WORKBENCH, 10);
		register(Material.GOURD, CraftingIngredient.NO_WORKBENCH, 20 * 5);
		register(Material.METAL, CraftingIngredient.COPPER_CRAFTING_TABLE, 20 * 3 * 9);
		register(Material.UNDERWATER_PLANT, CraftingIngredient.NO_WORKBENCH, 20);
		register(Material.REPLACEABLE_UNDERWATER_PLANT, CraftingIngredient.NO_WORKBENCH, 20);
		register(Material.STONE, CraftingIngredient.FLINT_CRAFTING_TABLE, 20);
		register(Material.SNOW_LAYER, CraftingIngredient.NO_WORKBENCH, 10);
		register(Material.POWDER_SNOW, CraftingIngredient.NO_WORKBENCH, 5);
